...
<html>
	...
	<body>
		<form id="aasx" action="epor.do?actionType=doApprovePR" method="post" >
			...
			<input type="hidden"
				name="approvedPR.prPrForm.tempolyeeByApplicantId.mail"
				value="${prForm.tempolyeeByApplicantId.mail}">
			...
			<table width=1240>
				...
				<tr>
					<td>
						<select id="suggId" name="approvedPR.isApproved"
							onchange="rejectDlg(this)">
							<option value="1">
								Approve
							</option>
							<option value="0">
					...
					<td>
						<textarea rows="" cols="60%" name="approvedPR.context"></textarea>
					</td>
				</tr>
				<tr>
					<td colspan="3">
