					...
					<TR class=altbg1>
						<TD height=25 width="100%" align="center" bgcolor="#D6E0EF">
							...
							<a class="menu" target="main"
								href="personal.do?actionType=doGotoInsertByForm">车间生产记录录入</a>
						</TD>
					</TR>
					<TR class=altbg1>
						<TD height=25 width="100%" align="center" bgcolor="#D6E0EF">
							<img border="0" src="images/icon_arrow_r.gif" width="13"
								height="13">
							<a class="menu" target="main"
								href="front/PersonalEffectRegisterByExcel.jsp">车间生产记录EXCEL录入</a>
						</TD>
					</TR>
					<TR class=altbg1>
										...
										<TR>
											<TD height=25 width="100%" align="center" bgcolor="#D6E0EF">
												<img border="0" src="images/icon_arrow_r.gif" width="13"
													height="13">
												<a class="menu" target="main"
													href="post.do?actionType=doSelectPostAll">标准定义</a>
											</TD>
										</TR>
										</mytag:rights>
										<TR>
											<TD height=25 width="100%" align="center" bgcolor="#D6E0EF">
												<img border="0" src="images/icon_arrow_r.gif" width="13"
													height="13">
												<a class="menu" target="main"
													href="front/hrpost/PostAdd.jsp">浮动岗位添加</a>
											</TD>
										</TR>
					...
					<TR class=altbg1>
						<TD height=25 width="100%" align="center" bgcolor="#D6E0EF">
							<img border="0" src="images/icon_arrow_r.gif" width="13"
								height="13">
							<a class="menu" target="main"
								href="personal.do?actionType=selectAll">浮动岗位工资计算结果及报表查询</a>
						</TD>
					</TR>
				</mytag:rights>
			</table> </span>
			...
			<table cellspacing="1" cellpadding="4" width="158"
				...
				<TR>
					<TD height=25 width="100%" align="center" bgcolor="#D6E0EF">
						<img border="0" src="images/icon_arrow_r.gif" width="13"
							height="13">
						<a class="menu" target="main" href="front/hrpost/PostUpdate.jsp">浮动岗位查询/更改</a>
					</TD>
				</TR>
			</table> </span>
				</mytag:rights>
