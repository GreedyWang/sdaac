...
<table cellspacing="1" cellpadding="4" width="90%"
   ...
   <td align="center" class="altbg1"><b>总完成时间</b></td>
...
<c:if test="${postList!=null }">
 ...
 <tr>  
   ...
   <td align="center" class="altbg1">${postList.tpostType.type }</td>  
    <td align="center" class="altbg1">${postList.target }</td>  
     <td align="center" class="altbg1">${postList.finishQuality }</td>  
      <td align="center" class="altbg1">${postList.totalTime }</td>  
