...
<html>
  ...
  function keyDown()
  {
	...
	<div style="position: relative;left: 100; top: 100">
	 ...
	 <form action="login.do?actionType=doLoginByNetID" method="post" id="loginFrom">
			...
			<DIV id=cap-body>
				<DIV>
						...
						<DIV>
							...
							<DIV style="position: relative; top: 15px;">
								...
								<select class='textbox340' name="OU" style="color: #999;">
									<option value="Shanghai" selected="selected">
										Shanghai
									</option>
					...
					<div
						...
						<a href="mailto:yongmin.wang@delphi.com">Mail : yongmin.wang@delphi.com</a>
					</DIV>
					</DIV></DIV></DIV></form>
	</body>
</html>
