...
<html>
  ...
  <body >
	...
	<tr><jsp:include flush="true" page="Outside the department/Select_TopBar_Form.jsp"></jsp:include></tr>
   ...
   <td>状态</td>
   <td><a href="javascript:void(2)" id="idAddtime">日期</a></td>
   <td>提案人</td>
 	<td>提案部门</td>
   <td colspan="2">主题</td>
   </tr></thead>
   ...
   <td colspan="2"><a href="proposal.do?actionType=doSelectByProposalIDS&proposalID=${item.id }">${item.title }</a></td>
   </tr>
   </c:forEach>
   </tbody>
  </table>
