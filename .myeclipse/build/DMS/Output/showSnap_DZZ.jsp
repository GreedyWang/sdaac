	...
	<body>
		...
		<table  width="90%"cellspacing="1" cellpadding="4"  class="tableborder">
			<tr >
				...
				<td align="center" class="header">大组长个人奖金</td>
				<td align="center" class="header">大组奖金额度</td>
			...
			<c:forEach items="${templetes}" var="item">
				<tr>
					...
					<td width="30px" align="center" class="altbg1">
						${item.totalBouns/item.peopelCount*2 }
					</td>
					<td width="30px" align="center" class="altbg1">
						${item.totalBouns - item.totalBouns/item.peopelCount*2 }
					</td>
					<td width="30px" align="center" class="altbg1">
						${item.totalBouns/item.peopelCount }
					</td>
				</tr>
			</c:forEach>
