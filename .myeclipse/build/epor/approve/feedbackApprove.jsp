	...
	<body onload="loadCostcentreData()">
		<form id="aasx" action="epor.do?actionType=doApprovePR"
			...
			<table width=1240>
				...
				<tr>
				<input name="approvedPR.prPrForm.totalCategroy" type="hidden"  id ="totalCategroy3" >
				...
				<TR>
					<td>
						<input type="button" value="submit" onclick="valify3()">
					</td>

				</TR>

			</table>
			<input id="totalCategroy3" type="hidden"
				name="approvedPR.prPrForm.totalCategroy">
		</form>
	</body>
			<script type="text/javascript">  
			
	if(${prForm.isCapital} == 0 ){
		var number = 'S011720000';
