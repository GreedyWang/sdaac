...
<html>
	<head>
		...
		<script type="text/javascript" src='epor/js/updatePrForm.js'></script>
	...
	function changeBuyer(area){
		...
		loadCostcentreData2(area.value);
		//change buyer
	...
	<body onload="init()">
		...
		<!--  -->
		<form id="form" action="epor.do?actionType=doUpdate" enctype="multipart/form-data" method="post">
			...
			<input type="hidden" id="state" name="prForm.state" value="${prForm.state }">
			...
			<table width="100%">
				...
				<tr>
					<td>
						紧急采购<input id="isUrgency" type="checkbox" name="prForm.isUrgency" value="1" >
					</td>
				</tr>				
				<tr>
				...
				<tr>
					<td colspan="3">
						...
						<select id="projectId" name="prForm.prProject.id" onchange="changeARNO(this.value)">
						</select>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						...
						<input class="required" id="arno" type="text" name="prForm.arno" value="${prForm.arno }">	
						<div id="bb"></div>
				...
				<tr>
					...
					<td>
						单一供应商<input id="isAssignation" type="checkbox" name="isAssignation" value="1" >
					</td>
				</tr>
			...
			<table width="100%">
				...
				<c:if test="${isWaitting == 1}">
					<tr>
						<td>
							<label>解释理由:</label>
						</td>
							<td colspan="2">
								<textarea rows="3" cols="100" name="approvedPR.context"></textarea>
							</td>
					</tr>
				</c:if>
				<tr>
				<c:if test="${isWaitting != 1}">
					...
					<td>
						<input type="button" value="保存" onclick="sub(1,'${prForm.id }')">
					</td>
				</c:if>
				<c:if test="${isWaitting == 1}">
					<td>
						<select name="approvedPR.helpExplain" >
							<option value="1" >正常修改</option>
							<option value="2" >交由采购修改</option>
							<option value="3" >交由财务修改</option>
							<option value="4" >交由OTS修改</option>
						</select>
					</td>
					<td>
						<input type="button" value="提交" onclick="sub(3,'${prForm.id }')"> 
					</td>		
