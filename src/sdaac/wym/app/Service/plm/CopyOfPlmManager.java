...
//
//import sdaac.wym.app.Dao.plm.EBomDao;
//import sdaac.wym.app.Dao.plm.EPartDao;
//import sdaac.wym.app.Dao.plm.IBomDao;
...
//
//public class CopyOfPlmManager {
//	private IBomDao mbomDao=null;
//	private PartDao mpartDao=null;
//	private EBomDao ebomDao;
//	private EPartDao epartDao;
//	
//	private Map<Integer, List<MBom>> rs=new HashMap<Integer, List<MBom>>();
//
//	public List<MPart> selectMPartByCond(String cond,Page page,boolean isA)
//	{
//		if(isA)
//		{
//			return this.mpartDao.selectMPartByCondA(cond, page);
//		}else
//		{
//			return this.mpartDao.selectMPartByCond(cond, page);
//		}
//	}
//	
//	public List<Epart> selectEPartByCond(String cond,Page page,boolean isA)
//	{
//		if(isA)
//		{
//			return this.epartDao.selectEpartByCondA(cond, page);
//		}else
//		{
//			return this.epartDao.selectEpartByCond(cond, page);
//		}
//	}
//	
//	/**
...
//	 * @param myTree
//	 */
//	public void selectSeries(String pk,MyTree<Bom> myTree)//Map<Integer, List<MBom>> rs
//	{		
//
//		List<Bom> mboms=isLeaf(pk);
//		
//		if(mboms!=null)
//		{
//			
...
//				}
//				selectSeries(mboms.get(i).getCid(),myTree.getChildren().get(i));
//			}
//		}
//		
//	}
...
//	 * @param myTree
//	 */
//	public void reSelectSeries(String pk,MyTree<Bom> myTree)//Map<Integer, List<MBom>> rs
//	{		
//
...
//	 * @param myTree
//	 */
//	public void selectSeries2(String pk,MyTree<Bom> myTree)//Map<Integer, List<MBom>> rs
//	{		
//
...
//	 * @param myTree
//	 */
//	public void reSelectSeries2(String pk,MyTree<Bom> myTree)//Map<Integer, List<MBom>> rs
//	{		
//
...
//	{
//		List<Bom> mboms=mbomDao.selectChild(pk);
...
//	 * @return
//	 */	
//	public Map<Integer, List<Part>> changetoMbom(MyTree<Bom> item,MyTree<Part> mp2)
//	{		
...
//		return null;		
//	}
//	public Map<Integer, List<Part>> changetoMbom2(MyTree<Bom> item,MyTree<Part> mp2)
//	{		
//		if(item.getNode()!=null)
//		{
...
//		return null;		
//	}
////	public Map<Integer, List<MPart>> changetoMbom2(MyTree<Ebom> item,MyTree<Epart> mp2)
////	{
////		
////		
////		if(item.getNode()!=null)
...
//		return this.mpartDao.selectByPk(pk );
//	}
//	
...
//		CopyOfPlmManager pm=(CopyOfPlmManager)ac.getBean("plmManager");
//		//pm.test();
//	}
//	
//
...
//	//--------------------------------
//	
//	public IBomDao getMbomDao() {
//		return mbomDao;
//	}
//	public void setMbomDao(IBomDao mbomDao) {
//		this.mbomDao = mbomDao;
//	}
//	public PartDao getMpartDao() {
//		return mpartDao;
//	}
//	public void setMpartDao(PartDao mpartDao) {
//		this.mpartDao = mpartDao;
//	}
//
//	public Map<Integer, List<MBom>> getRs() {
//		return rs;
//	}
//
//	public void setRs(Map<Integer, List<MBom>> rs) {
//		this.rs = rs;
//	}
//	public EBomDao getEbomDao() {
//		return ebomDao;
//	}
//	public void setEbomDao(EBomDao ebomDao) {
//		this.ebomDao = ebomDao;
//	}
//	public EPartDao getEpartDao() {
//		return epartDao;
//	}
//	public void setEpartDao(EPartDao epartDao) {
//		this.epartDao = epartDao;
//	}
//}
