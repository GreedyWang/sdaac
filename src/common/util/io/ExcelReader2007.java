...
public class ExcelReader2007 {
     ...
     * @return
     */
    protected String getRightStr(String sNum)
    {
    ...
    public List<ArrayList<String>> readByIos(InputStream inputStream,String fileName) {
    	boolean isExcel2003 = true;
        /** *//** 对文件的合法性进行验证 */
        if (fileName.matches("^.+\\.(?i)(xlsx)$"))
        {
       ...
       return read(inputStream,isExcel2003);
    }
